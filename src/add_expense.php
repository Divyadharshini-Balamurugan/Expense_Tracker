...
<body>
                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="date" class="form-control col-sm-12" value="<?php echo $expensedate; ?>" name="expensedate" id="expensedate" min="2000-01-01" required>
                                </div>
                            </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById('expensedate').max = formattedDate;
        });
    </script>
    <script>
        feather.replace();
